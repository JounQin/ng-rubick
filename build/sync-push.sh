...
main() {
  ...
  then
    ...
    {
      git clone https://user:${GH_TOKEN}@github.com/JounQin/ng-rubick.git sync -b gh-pages
    } || {
      ...
      git remote add origin https://user:${GH_TOKEN}@github.com/JounQin/ng-rubick.git
      cd ..
    }
